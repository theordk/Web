  ...
  <body>
    ...
    <?php include("ad_menu.php"); ?>
        ...
        <div class="container-fluid">
          <h2>Items Ferrailles</h2> <br>
          <p>Voici les différents items disponibles en vente dans la catégorie Ferrailles.</p><br>
    ...
    if ($db_found) {
      $sql = "SELECT * FROM article WHERE Categorie LIKE 'Ferraille et Tresor' AND Bool = '0'";
