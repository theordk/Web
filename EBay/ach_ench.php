...
<body>
  ...
  <div class="container-fluid">
    <h3>Articles disponibles en Enchères</h3> <br><br>
    <?php
    ...
    if ($db_found) {
    $sql = "SELECT * FROM article WHERE Bool = '0' AND (TypeVente LIKE '100' OR TypeVente LIKE '110' OR TypeVente LIKE '101' OR TypeVente LIKE '111')";
