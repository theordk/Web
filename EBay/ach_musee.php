...
<body>
  ...
  <div class="container-fluid">
    <h2>Musee</h2><br>
    <p>Voici les différents items disponibles en vente dans la catégorie Musée.</p><br>
    <?php
    ...
    if ($db_found) {
      $sql = "SELECT * FROM article WHERE Categorie = 'Bon pour le Musee' AND Bool = '0'";
