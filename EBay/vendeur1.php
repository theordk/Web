 ...
 <body>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-4">
        <h4 class="text-center"><a href="vend_ferraille.php">Tresor/Feraille</a></h4>
      ...
      <div class="col-sm-4">
        <h4 class="text-center"><a href="vend_musee.php">Bons pour musee</a></h4>
      ...
      <div class="col-sm-4">
        <h4 class="text-center"><a href="vend_vip.php">Luxe/VIP</a></h4>
