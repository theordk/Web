  ...
  <div class="container-fluid">
    ...
    <?php
     ...
     //identifier le nom de base de données
      ...
      //OK j'ai l'ID de mon acheteur 

      //si la BDD existe, faire le traitement
      if ($db_found) {
        //Je selectionne toutes les infos de negociation sur les articles qui correspondent au acheteur
        $sql = "SELECT * FROM negocie WHERE ID_Acheteur LIKE '%$id_ach%' AND Bool LIKE '1'";
        $result = mysqli_query($db_handle, $sql);
        ...
        echo "Formulaire de gestion d'une offre : <br><br>"; 
         echo '
          <html>
          <body>
            <form action="ach_gerer_offreBack.php" method="post" name="myForm">
            <tr>
              <td>ID Article : </td>
          ...
          <html>';
          echo "Voici les offres qui ont été faites sur les articles que vous souhaitez acheter."."<br>";
          echo "Vous pouvez choisir d'accepter l'offre du vendeur ou bien de lui en proposer une nouvelle.<br><br>";
