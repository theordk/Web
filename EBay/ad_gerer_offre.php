 ...
 <head>
   <title>Admin gerer offres</title>
   <meta charset="utf-8">
    ...
    <?php
     ...
     //identifier le nom de base de données
      ...
      if ($db_found) {
        ...
        $sql = "SELECT * FROM negocie WHERE ID_Vendeur LIKE '%$id_vend%' AND Bool = '0'";
        $result = mysqli_query($db_handle, $sql);
   

        echo "Formulaire de gestion d'une offre : <br>"; 
         echo '
          <html>
          <body>
            <form action="ad_gerer_offreBack.php" method="post" name="myForm">
            <tr>
              <td>ID Article : </td>
