...
<body>
  ...
  <div class="container-fluid">
    <h3>Articles disponibles en Achat Immediat</h3> <br><br>
    ...
    if ($db_found) {
    $sql = "SELECT * FROM article WHERE Bool = '0' AND (TypeVente LIKE '010' OR TypeVente LIKE '110' OR TypeVente LIKE '011' OR TypeVente LIKE '111')";
    $result = mysqli_query($db_handle, $sql);
    
    //echo "<th>" . "Achat Immediat" . "</th>";
